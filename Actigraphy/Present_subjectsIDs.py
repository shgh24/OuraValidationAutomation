...
Saving_file_path = '/Volumes/CSC5/SleepCognitionLab/Tera2b/Experiments/OuraValidation/Oura3/analysis/DeZambotti/Acti/Common_Subj_N1/'
...
for files in fi:
    ...
    Subjects.to_csv(files.replace('combined_data',
                    'SubjectID').replace('June_20_2023/', ''), index=False)
