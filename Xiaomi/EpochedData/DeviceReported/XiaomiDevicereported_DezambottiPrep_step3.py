...
Saving_file_path = "/Volumes/CSC5/SleepCognitionLab/Tera2b/Experiments/OuraValidation/Oura3/analysis/DeZambotti/Xiaomi/Data/DeviceOnly"
...
for Night in nights:
    ...
    for PSG_Scores in Consesnus_Scores:
        ...
        HPB_data = glob.glob(os.path.join(
            staging_file_path_xiaomi, "subjectbysubject_RAW", f"NUS*{Night}*.csv"))
        matching_files = [
        ...
        if matching_files:
            ...
            for HPB in matching_files:
                ...
                combined_data['reference'] = df_PSG.iloc[:, 3]
                combined_data['device'] = df_HPB.iloc[:, 3]
