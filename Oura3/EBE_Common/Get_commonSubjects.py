...
for devi in devices:
    ...
    data_dir = f'/Volumes/CSC5/SleepCognitionLab/Tera2b/Experiments/OuraValidation/Oura3/analysis/DeZambotti/{devi}/Data/EBE/Common_epochs'
    ...
    fi = glob.glob(data_dir + '/combined*N01*L*.csv')
    ...
    for files in fi:
        ...
        new_df.to_csv(files.replace('/Common_epochs',
                                    '/Common_epochs/Common_Subj_N1_Nodreem'), index=False)
