...
clc;clear all;
addpath('/Volumes/CSC5/SleepCognitionLab/Tera2b/Experiments/OuraValidation/Oura2/Analyses/PSG_FB_OURA')
...
FB_Output_dir='/Volumes/CSC5/SleepCognitionLab/Tera2b/Experiments/OuraValidation/Oura3/analysis/DeZambotti/FB/Data/EBE/RAW_Data/';
        ...
        if ~isempty(ind) 
          ...
          %  save(fullfile(base_path,fname),'epochs_stages');
            ...
            if FBend_epoch>(size(epochs_stages,1))
               Wake_ep_end=zeros(1, FBend_epoch -size(epochs_stages,1))'+7;
            ...
            if FBstart_epoch<=0
                Wake_ep_strt=zeros(1,(-1*FBstart_epoch))'+7;     
